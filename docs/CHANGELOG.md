...
- [#48](https://gitlab.com/california-college-of-the-arts/libraries.cca.edu/-/issues/48) use kubernetes secrets for Summon SFTP details as opposed to `docker cp` (security)
