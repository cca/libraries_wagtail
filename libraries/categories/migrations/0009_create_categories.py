...
def create_categories(apps, schema_editor):
    ...
    try:
        ...
        # Database schema still being set up; skip deletion
        pass
    ...
    try:
        ...
        # Create a new categories as children of home page
        home_page.add_child(instance=about_us)
        home_page.add_child(instance=collections)
        home_page.add_child(instance=services)
    except (Page.DoesNotExist, OperationalError, AttributeError, TypeError):
        # If home page doesn't exist or schema still being set up, skip creation
...
def remove_categories(apps, schema_editor):
    ...
    try:
        ...
        # Database schema issues; migration can't complete cleanup anyway
        pass
