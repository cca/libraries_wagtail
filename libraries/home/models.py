...
class HomePage(Page):
    ...
    services_link = StreamField([("link", LinkBlock())], blank=True)
    collections_text = RichTextField(features=settings.RICHTEXT_BASIC, blank=True)
    collections_link = StreamField([("link", LinkBlock())], blank=True)
    about_us_text = RichTextField(features=settings.RICHTEXT_BASIC, blank=True)
    about_us_link = StreamField([("link", LinkBlock())], blank=True)
